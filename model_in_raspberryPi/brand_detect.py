...
#  print(output)
#  print(f'prediction: {(output[1])*100:.2f}%')
 ...
 # print(ordered)
 # print([(i, output[i]) for i in ordered[:top_k]][0])
...
model_path = data_folder + "brand_Xception_adam_epoch20_batch16.tflite"
# "brand_recog.tflite"
label_path = data_folder + "brand_labels.txt"
